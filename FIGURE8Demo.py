...
def rank_comparison(tenor, verb, adj, vehicle, metaphor):
  # Semantic similarity.
  ...
  # Number of Google results for the noun-verb and adj-noun pairings.
  print("Number of Google results for '[" +tenor["name"]+"] ["+verb+ "]': " + str(test_coherence(tenor["name"],verb)))
  print("Number of Google results for '[" +adj+"] ["+tenor["name"]+ "]': " + str(test_coherence(adj,tenor["name"])))
...
def main():
  ...
  for y in range(0, 3):
    ...
    if (verb != "[VERB]" and adj != "[ADJ]"):
      ...
      ### RANK GENERATION ###
      print "\nRANKING STATISTICS"
      rank_comparison(tenor,verb,adj,vehicle,simile)
